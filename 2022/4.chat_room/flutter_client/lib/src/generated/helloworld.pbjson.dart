...
@$core.Deprecated('Use currentUsersUUIDReplyDescriptor instead')
const CurrentUsersUUIDReply$json = const {
  '1': 'CurrentUsersUUIDReply',
  '2': const [
    const {'1': 'uuid', '3': 1, '4': 3, '5': 9, '10': 'uuid'},
  ],
};
